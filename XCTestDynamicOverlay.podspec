#
#  Be sure to run `pod spec lint XCTestDynamicOverlay.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.4.1"
  spec.summary      = "A short description of XCTestDynamicOverlay."
  ...
  spec.source       = { :git => "https://github.com/szymhan/xctest-dynamic-overlay.git", :tag => "#{spec.version}" }
